"""
Django settings for CXRepo project.
...
SECRET_KEY = 'django-insecure-r*v9f07b*#t%g(1r2b&*+*-*h%s#7m-m8ji#$_dwder$=a^9#6'
...
REST_FRAMEWORK = {
    ...
    # Для drf-spectacular (рекомендуется)
...
SPECTACULAR_SETTINGS = {
    ...
    'REDOC_DIST': 'SIDECAR',
    'TITLE': 'CXRepo API Documentation',
}
...
WSGI_APPLICATION = 'CXRepo.wsgi.application'
...
CAPTCHA_FOREGROUND_COLOR = '#ff6b6b'
